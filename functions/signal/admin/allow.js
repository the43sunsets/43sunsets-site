...
import { store, ingestOk, bearerOk, json, isFreeMail } from "../_lib.js";
...
export async function onRequestPost({ request, env }) {
  ...
  await kv.allow("dom", domains.filter(d => !skipped.includes(d)), !!b.remove);
  await kv.allow("eml", emails, !!b.remove);
