...
CREATE TABLE IF NOT EXISTS company_view (day TEXT NOT NULL, email TEXT NOT NULL, company_id TEXT NOT NULL, n INTEGER NOT NULL DEFAULT 0, PRIMARY KEY (day, email, company_id));
